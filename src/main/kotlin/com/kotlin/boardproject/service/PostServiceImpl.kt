...
import com.kotlin.boardproject.dto.ReadOneNormalPostResponseDto
...
class PostServiceImpl(
    ...
    @Transactional
    override fun createNormalPost(username: String, createNormalPostRequestDto: CreateNormalPostRequestDto) {
        // 유저 확인
    ...
    override fun readOneNormalPost(postId: Long): ReadOneNormalPostResponseDto {
        val post =
        ...
        return ReadOneNormalPostResponseDto(
            id = post.id!!,
    ...
    @Transactional
    override fun editNormalPost(username: String, postId: Long, editNormalPostRequestDto: EditNormalPostRequestDto): Long {
        val user = userRepository.findByEmail(username) ?: throw EntityNotFoundException("존재하지 않는 유저 입니다.")
        ...
        // TODO: mapper같은 함수 활용
        post.title = editNormalPostRequestDto.title
        post.isAnon = editNormalPostRequestDto.isAnon
        post.commentOn = editNormalPostRequestDto.commentOn
        post.content = editNormalPostRequestDto.content
